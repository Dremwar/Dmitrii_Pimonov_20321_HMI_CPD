...
В этих двух программа я реализовал клиента, который с помошью Google Protocol Buffers закодирует значение и отправляет его на сервер, а потом с помошью такой-же функции но на сервере раскодировать и вывести в командную строку.

Скриншот5(ответ сервера через Google Protocol ):

![image](https://github.com/Dremwar/Dmitrii_Pimonov_20321_HMI_CPD/assets/96596871/80b02ac4-01d5-4d4c-af3e-827d0de8970b)
